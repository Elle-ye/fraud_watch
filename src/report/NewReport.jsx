          ...
          <Form onSubmit={submitReport}>
            <Row className="g-3">
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label className="text-secondary mb-1">
                    <i className="fas fa-calendar-day me-2"></i>Incident Date
                  </Form.Label>
                  <Form.Control
                    type="date"
                    id="incidentDate"
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label className="text-secondary mb-1">
                    <i className="fas fa-location-dot me-2"></i>Incident Location
                  </Form.Label>
                  <Form.Control
                    type="text"
                    id="incidentLocation"
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label className="text-secondary mb-1">
                    <i className="fas fa-paperclip me-2"></i>Attachments (optional)
                  </Form.Label>
                  <Form.Control
                    type="file"
